    ...
    <Layout>
      <main>
        <div className="base-page">
          ...
          <Link to="https://medium.com/lucid-software-design/the-lucid-ux-intern-experience-pandemic-edition-5693a1704bd0">[November 2020] The pandemic intern experience @ Lucid Software ↗</Link>
          </div>
        </div>
      </main>
    </Layout>
